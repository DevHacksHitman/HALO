...
export function buildReceiptVerificationBearerRequest({
  ...
  const body = buildReceiptVerificationBody({need, requestedAmountUsd, receiptImageUrl, model});
...
function buildReceiptVerificationBody({need, requestedAmountUsd, receiptImageUrl, model}) {
  return {
    model: requireNonEmptyString(model, "model"),
    messages: buildReceiptVerificationMessages({need, requestedAmountUsd, receiptImageUrl}),
    response_format: {type: "json_object"},
