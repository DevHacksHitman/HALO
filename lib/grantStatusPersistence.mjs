...
export const UPSTASH_REDIS_REST_URL_FALLBACK_ENV_VARS = Object.freeze([
...
export const UPSTASH_REDIS_REST_TOKEN_FALLBACK_ENV_VARS = Object.freeze([
...
function readUpstashConfig(env) {
  const url = readFirstEnvValue(env, [
    UPSTASH_REDIS_REST_URL_ENV_VAR,
    ...UPSTASH_REDIS_REST_URL_FALLBACK_ENV_VARS,
  ]);
  const token = readFirstEnvValue(env, [
    UPSTASH_REDIS_REST_TOKEN_ENV_VAR,
    ...UPSTASH_REDIS_REST_TOKEN_FALLBACK_ENV_VARS,
  ]);
  if (!url || !token) {
    return null;
  }
